...
~/bin/android-sdk-linux/build-tools/24.0.0/zipalign -v 4 ./platforms/android/build/outputs/apk/android-x86-release-unsigned.apk x86_net.khertan.forrunners.apk
~/bin/android-sdk-linux/build-tools/24.0.0/zipalign -v 4 ./platforms/android/build/outputs/apk/android-armv7-release-unsigned.apk armv7_net.khertan.forrunners.apk
